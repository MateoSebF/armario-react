...
const Outfit = ({ makeOutfit, day, handleSubmmit }) => {
    ...
    useEffect(() => {
        const getLayers = async () => {
            try {
                const layers = [];
                var answer = await axios.get(`https://clothcraft.azurewebsites.net/clothing/byType/86db7be3-be82-4f7f-9fa1-0c53db05531c/SHIRT`);
                layers[0] = answer.data;
                answer = await axios.get(`https://clothcraft.azurewebsites.net/clothing/byType/86db7be3-be82-4f7f-9fa1-0c53db05531c/PANTS`);
                layers[1] = answer.data;
                answer = await axios.get(`https://clothcraft.azurewebsites.net/clothing/byType/86db7be3-be82-4f7f-9fa1-0c53db05531c/SHOES`);
