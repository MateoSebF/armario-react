...
const ProductListing = ({ product }) => {
  return (
    <div className="product-listing" style={{ marginBottom: '20px' }}>
      <div className="product-frame" style={{ borderStyle: 'dashed', borderColor: '#2A2829', borderWidth: '0px', padding: '15px', borderRadius: '50%', width: '150px', height: '150px' , backgroundColor: '#934A21' }}>
